...
api[0].list.push({
    alias: 'PrescriptionRemindController',
    order: '2',
    link: '用户提醒器',
    desc: '用户提醒器',
    list: []
...
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/rest/clinc/prescription/reminder/list',
    methodId: 'e705d8b8891b5a939f4f465b9c183670',
    desc: '获取当前用户具有查询权限的就诊提醒记录',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'https://dev.gateway.api.asialjim.cn/api/rest/clinc/prescription/reminder/{id}',
    methodId: 'a0e6928a06bed890939bd32954e0a386',
    desc: '根据记录编号精确查询详情',
});
