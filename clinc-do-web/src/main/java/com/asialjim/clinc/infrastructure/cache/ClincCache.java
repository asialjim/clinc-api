...
package com.asialjim.clinc.infrastructure.cache;
 ...
 */
@Configuration
public class ClincCache extends CacheNameAndTTLConfig {
    public interface Name {
        String prescriptionRecordById = "tmp:prescription:record:by-id";
    }

    @Getter
    enum Cache implements CacheNameAndTTL {
        appPoById(Name.prescriptionRecordById),
